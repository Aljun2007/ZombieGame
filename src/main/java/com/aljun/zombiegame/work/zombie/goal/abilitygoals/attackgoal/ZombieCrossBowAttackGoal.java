...
public class ZombieCrossBowAttackGoal extends AbstractZombieAbilityGoal implements ICrossbowUser {
    public static final DataParameter<Boolean> IS_CHARGING_CROSSBOW = EntityDataManager.defineId(ZombieEntity.class, DataSerializers.BOOLEAN);

    public static final DataParameter<Boolean> IS_CHARGING_CROSSBOW_VILLAGER = EntityDataManager.defineId(ZombieVillagerEntity.class, DataSerializers.BOOLEAN);
    ...
    public ZombieCrossBowAttackGoal(ZombieMainGoal mainGoal, ZombieEntity zombie) {
        ...
        if (livingentity != null) {
            ...
            if (this.crossbowState == CrossbowState.UNCHARGED) {
                ...
                this.zombie.startUsingItem(
                        ProjectileHelper.getWeaponHoldingHand(this.zombie, item -> item instanceof CrossbowItem));
    ...
    public void setChargingCrossbow(boolean b) {
        try {
            if (this.zombie instanceof ZombieVillagerEntity) {
    ...
    @Override
        public void shootCrossbowProjectile( LivingEntity target,  ItemStack stack,
                ProjectileEntity projectile, float p_34710_) {
