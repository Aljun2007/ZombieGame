                ...
                Commands.argument("day_total", IntegerArgumentType.integer(0, 1000)).executes((context -> {
                    if (!GameProperty.isStartGame(context.getSource().getLevel())) {
                        ...
                        context.getSource().sendSuccess(
                                new TranslatableComponent("command.zombiegame.start_game.successful"), true);
                        ServerPlayer player = null;
                        if (context.getSource().getEntity() instanceof ServerPlayer) {
                            player = (ServerPlayer) context.getSource().getEntity();
                        }
                        if (player != null) {
                            Chatting.sendMessagePlayerCertain(new TranslatableComponent("message.zombiegame.successful",
                                            new TranslatableComponent("message.zombiegame.startgame.started")).getString(),
                                    player);
                        ...
                        Chatting.sendMessagePlayerAll(new TranslatableComponent("message.zombiegame.warn",
                                new TranslatableComponent("message.zombiegame.startgame.sever_started",
                                        new TranslatableComponent("message.zombiegame.info.normal"))).getString());
                    } else {
                        context.getSource().sendFailure(
                                new TranslatableComponent("command.zombiegame.start_game.failed"));
                    }
                    return 0;
                }))).executes((context -> {
            if (!GameProperty.isStartGame(context.getSource().getLevel())) {
                ...
                context.getSource().sendSuccess(new TranslatableComponent("command.zombiegame.start_game.successful"),
                        true);
                ServerPlayer player = null;
                if (context.getSource().getEntity() instanceof ServerPlayer) {
                    player = (ServerPlayer) context.getSource().getEntity();
                ...
                if (player != null) {
                    Chatting.sendMessagePlayerCertain(new TranslatableComponent("message.zombiegame.successful",
                            new TranslatableComponent("message.zombiegame.startgame.started")).getString(), player);
                ...
                context.getSource().sendFailure(new TranslatableComponent("command.zombiegame.start_game.failed"));
            }
            return 0;
                ...
                Commands.argument("game_stage", DoubleArgumentType.doubleArg(0d, 1d)).executes((context -> {
                    if (!GameProperty.isStartGame(context.getSource().getLevel())) {
                        ...
                        Chatting.sendMessagePlayerAll(new TranslatableComponent("message.zombiegame.warn",
                                new TranslatableComponent("message.zombiegame.startgame.sever_started",
                                        new TranslatableComponent("message.zombiegame.info.remain"))).getString());
                    } else {
                        context.getSource().sendFailure(
                                new TranslatableComponent("command.zombiegame.start_game.failed"));
                    }
