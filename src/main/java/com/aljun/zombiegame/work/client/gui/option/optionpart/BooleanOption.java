...
public class BooleanOption extends AbstractOption<Boolean> {
    ...
    protected void initOption() {
        ...
        this.trueButton = new ModButton(0, 0, 60, 15, new TranslatableComponent("gui.zombiegame.true"), this::onPress);
        this.falseButton = new ModButton(0, 0, 60, 15, new TranslatableComponent("gui.zombiegame.false"), this::onPress);
    ...
    public Component getValueComponent() {
        return new TranslatableComponent("gui.zombiegame." + this.getValue());
    }
