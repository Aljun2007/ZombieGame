...
public class ZombieGameOptionsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.OPTION_LIKES.forEach((key, optionLike) -> {
            ...
            ModButton optionLikeButton = new ModButton(
                    ...
                    new TranslatableComponent("gui.zombiegame.option_like." + optionLike.ID), (b) -> {
        ...
        this.saveButton = new ModButton(this.width - 120, lineSize / 3, 50, 15,
                new TranslatableComponent("gui.zombiegame.button.save"),
                (button) -> this.onSave());
        ModButton cancelButton = new ModButton(this.width - 65, lineSize / 3, 50, 15,
                new TranslatableComponent("gui.zombiegame.button.cancel"),
    ...
    private void onSave() {
        Chatting.sendMessageLocalPlayerOnly(new TranslatableComponent("message.zombiegame.warn",
                new TranslatableComponent("message.zombiegame.option_value.saving")));
    ...
    private void onCancel() {
        Chatting.sendMessageLocalPlayerOnly(new TranslatableComponent("message.zombiegame.warn",
                new TranslatableComponent("message.zombiegame.option_value.canceled")));
        this.onSafeClose();
    }
    ...
    public <T extends GuiEventListener & Widget & NarratableEntry> void addRW(T a) {
