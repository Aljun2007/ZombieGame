...
public abstract class AbstractOption<T> {
    ...
    public boolean equals(Object object) {
        if (object instanceof AbstractOption<?>) {
            return ((AbstractOption<?>) object).getKeySet().KEY.equals(this.getKeySet().KEY);
        }
        return false;
    }
    ...
    protected void initOption() {
        ...
        this.saveButton = new ModButton(0, 0, 60, 15,new TranslationTextComponent("gui.zombiegame.button.save"),
                (button) -> this.save());
        this.resetButton = new ModButton(0, 0, 60, 15, new TranslationTextComponent("gui.zombiegame.button.reset"),
                (button) -> this.reset());
        this.modifyButton = new ModButton(0, 0, 60, 15,new TranslationTextComponent("gui.zombiegame.button.modify"),
                (button) -> this.father.startModify(this));
        this.cancelButton = new ModButton(0, 0, 60, 15,new TranslationTextComponent("gui.zombiegame.button.cancel"),
                (button) -> this.cancel());
        ...
        this.SCREEN.addB(this.modifyButton);
        this.SCREEN.addB(this.saveButton);
        this.SCREEN.addB(this.cancelButton);
        this.SCREEN.addB(this.resetButton);
        this.SCREEN.addB(this.nameText);
        this.SCREEN.addB(this.valueText);
    ...
    public ITextComponent getValueComponent() {
        return new StringTextComponent(String.valueOf(this.OPTION_VALUE.value));
    }
