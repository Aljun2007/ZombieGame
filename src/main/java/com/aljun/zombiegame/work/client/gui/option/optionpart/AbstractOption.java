...
public abstract class AbstractOption<T> {
    ...
    protected void initOption() {
        ...
        this.saveButton = new ModButton(0, 0, 60, 15,new TranslatableComponent("gui.zombiegame.button.save"),
                (button) -> this.save());
        this.resetButton = new ModButton(0, 0, 60, 15, new TranslatableComponent("gui.zombiegame.button.reset"),
                (button) -> this.reset());
        this.modifyButton = new ModButton(0, 0, 60, 15,new TranslatableComponent("gui.zombiegame.button.modify"),
                (button) -> this.father.startModify(this));
        this.cancelButton = new ModButton(0, 0, 60, 15,new TranslatableComponent("gui.zombiegame.button.cancel"),
                (button) -> this.cancel());
    ...
    public Component getValueComponent() {
        return new TextComponent(String.valueOf(this.OPTION_VALUE.value));
    }
