    ...
    private static class PackStartGame {
                ...
                if (context.get().getDirection().equals(NetworkDirection.PLAY_TO_SERVER)) {
                    ...
                    if (player != null) {
                        ...
                        if (b) {
                            ...
                            Chatting.sendMessagePlayerCertain(new TranslatableComponent("message.zombiegame.error",
                                            new TranslatableComponent("message.zombiegame.startgame.has_started")).getString(),
                                    player);
                        }
        ...
        private void clientReceive() {
            Minecraft.getInstance().setScreen(
                    new StartGameScreen(new TranslatableComponent("gui.zombiegame.start_game.name")));
        }
